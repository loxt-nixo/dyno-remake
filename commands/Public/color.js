...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    embed
      .setColor(hexCode)
      .setTitle("Color Info for ", hexCode)
      .addFields(
        { name: "Name:", value: `${name.value || "N/A"}`, inline: false },
        {
          name: "RGB:",
          value: `R: ${rgb.r || "N/A"}, G: ${rgb.g || "N/A"}, B: ${
            rgb.b || "N/A"
          }`,
          inline: false,
        },
        {
          name: "HSL:",
          value: `H: ${hsl.h || "N/A"}, S: ${hsl.s || "N/A"}, L: ${
            hsl.l || "N/A"
          }`,
          inline: false,
        },
        {
          name: "API Link:",
          value: `[${hexCode}](https://www.thecolorapi.com/id?hex=${hexCode})`,
          inline: false,
        }
      )
      .setFooter({ text: "The color is the embed color!" })
      .setURL(`https://www.thecolorapi.com/id?hex=${hexCode}`);
