...
module.exports = {
    ...
    execute: async function (msg, client, args) {
        ...
        if (!role) return msg.channel.send({ embeds: [new EmbedBuilder().setColor(client.config.embedError).setDescription(`<:error:1205124558638813194> I couldn't find the role ${args[0] || ''}`)] });
